...
const SectionHeader = ({ children }: { children: string }) => (
  <h2 className="lg:hidden sticky top-0 z-10 py-5 text-[#ccc] text-sm uppercase tracking-[3px] font-medium border-neutral-800 mb-4 relative -mx-6 md:-mx-16 px-6 md:px-16">
...
export default function Home() {
  return (
    <>
      ...
      <div id="contact">
         <h2 className="lg:hidden bg-[#111] z-10 py-5 text-[#ccc] text-sm uppercase tracking-[3px] font-medium border-neutral-800 mb-4">
            Contact
          </h2>
